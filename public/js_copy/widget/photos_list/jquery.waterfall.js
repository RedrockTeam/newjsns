    ...
    $.fn.waterfall = function(options) {
        ...
        function getJSONData() {
            ...
            opts.params.ajax = ++ajaxTimes, ajaxFunc(function(jsonData) {
                //alert('erstgr');
                try {
                    "string" == typeof jsonData && (jsonData = $.parseJSON(jsonData)), console.log(jsonData), 
                    jsonData.current_page == jsonData.last_page ? (jsonCache = jsonCache.concat(jsonData.data).reverse(), 
