...
window._bd_share_main = {
    ...
    function r(e, t) {
        if (e instanceof Array) {
            for (var n = 0, r = e.length; r > n; n++) if (t.call(e[n], e[n], n) === !1) return;
        } else for (var n in e) if (e.hasOwnProperty(n) && t.call(e[n], e[n], n) === !1) return;
    }
    function i(e, t) {
        if (this.svnMod = "", this.name = null, this.path = e, this.fn = null, this.exports = {}, 
        this._loaded = !1, this._requiredStack = [], this._readyStack = [], i.cache[this.path] = this, 
        t && "." !== t.charAt(0)) {
            var n = t.split(":");
            n.length > 1 ? (this.svnMod = n[0], this.name = n[1]) : this.name = t;
        }
        this.svnMod || (this.svnMod = this.path.split("/js/")[0].substr(1)), this.type = "js", 
        this.getKey = function() {
            return this.svnMod + ":" + this.name;
        }, this._info = {};
    }
    function o(e, t) {
        var n = "css" == t, r = document.createElement(n ? "link" : "script");
        return r;
    }
    function u(t, n, r) {
        function c() {
        ...
        var s = o(t, n);
        "SCRIPT" === s.nodeName ? a(s, c) : f(s, c);
        var l = setTimeout(function() {
            throw new Error("load " + n + " timeout : " + t);
        }, e._loadScriptTimeout || 1e4), h = document.getElementsByTagName("head")[0];
        "css" == n ? (s.rel = "stylesheet", s.href = t, h.appendChild(s)) : (s.type = "text/javascript", 
        s.src = t, h.insertBefore(s, h.firstChild));
    }
    function a(e, t) {
    ...
    function l(e, t) {
        if (!t || !t.isCalled) {
            ...
            if (i || s) e.sheet && (n = !0); else if (e.sheet) try {
                ...
                ("SecurityError" === o.name || "NS_ERROR_DOM_SECURITY_ERR" === o.name) && (n = !0);
            }
            setTimeout(function() {
                n ? t && t() : l(e, t);
            }, 1);
    ...
    var n = "api";
    e.each = r, i.currentPath = "", i.loadedPaths = {}, i.loadingPaths = {}, i.cache = {}, 
    i.paths = {}, i.handlers = [], i.moduleFileMap = {}, i.requiredPaths = {}, i.lazyLoadPaths = {}, 
    i.services = {}, i.isPathsLoaded = function(e) {
        var t = !0;
        return r(e, function(e) {
            return e in i.loadedPaths ? void 0 : t = !1;
        }), t;
    }, i.require = function(e, t) {
        e.search(":") < 0 && (t || (t = n, i.currentPath && (t = i.currentPath.split("/js/")[0].substr(1))), 
        e = t + ":" + e);
        ...
        var t, n;
        return -1 !== (n = e.indexOf("/")) && (t = e.slice(0, n)), t && t in i.paths ? i.paths[t] : i.baseUrl;
    }, i.getJsPath = function(t, r) {
        if ("." === t.charAt(0)) {
            r = r.replace(/\/[^\/]+\/[^\/]+$/, ""), 0 === t.search("./") && (t = t.substr(2));
            var s = 0;
            for (t = t.replace(/^(\.\.\/)+/g, function(e) {
                return s = e.length / 3, "";
            }); s > 0; ) r = r.substr(0, r.lastIndexOf("/")), s--;
        ...
        return -1 !== (a = t.indexOf("/")) && (u = t.slice(0, a), f = t.lastIndexOf("/"), 
        l = t.slice(f + 1)), u && u in i.paths && (t = t.slice(a + 1)), c = d + o + "/js/" + t + ".js";
    }, i.get = function(e, t) {
        ...
        load: function() {
            ...
            if (r += e._useConfig && i.moduleFileMap[t][this.name] ? this.type + "/" + i.moduleFileMap[t][this.name] : this.type + "/" + this.name + (u ? "" : ".js"), 
            e._firstScreenCSS.indexOf(this.name) > 0 || e._useConfig && a == e._firstScreenJS) o._loaded = !0, 
            o.ready(); else {
                ...
                s.create({
                    ...
                    type: this.type,
                    loaded: function() {
                        o._info.loadedTime = new Date().getTime() - f, "css" == o.type && (o._loaded = !0, 
                        o.ready());
                    }
                });
            }
        ...
        lazyLoad: function() {
            if (this.name, i.lazyLoadPaths[this.getKey()]) this.define(), delete i.lazyLoadPaths[this.getKey()]; else {
        ...
        ready: function(e, t) {
            ...
            if (e) this._loaded ? e() : n.push(e); else {
                if (i.loadedPaths[this.path] = !0, delete i.loadingPaths[this.path], this._loaded = !0, 
                i.currentPath = this.path, this._readyStack && this._readyStack.length > 0) {
                    this._inited = !0;
                    var s, o = this.svnMod;
        ...
        define: function() {
            var e = this, t = this.deps, s = (this.path, []);
        ...
        getDependents: function() {
            var t = this.fn.toString(), n = t.match(/function\s*\(([^,]*),/i), i = new RegExp("[^.]\\b" + n[1] + "\\(\\s*('|\")([^()\"']*)('|\")\\s*\\)", "g"), s = t.match(i), o = [];
    ...
    var s = {
        create: function(e) {
            var t = e.src;
            t in this._paths || (this._paths[t] = !0, r(this._rules, function(e) {
                t = e.call(null, t);
            }), u(t, e.type, e.loaded));
        },
        _paths: {},
    ...
    e.version = "1.0", e.use = function(e, t) {
        ...
        if ("/" !== t.slice(-1) && (t += "/"), e in i.paths) throw new Error(e + " has already in Module.paths");
        i.paths[e] = t;
    };
    var c = n;
    e._setMod = function(e) {
        ...
        if ("object" == typeof t) r(t, function(t, n) {
            e._fileMap(n, t);
        }); else {
            var s = c;
            "string" == typeof n && (n = [ n ]), t = 1 == t.indexOf("js/") ? t.substr(4) : t, 
    ...
    }, e._eventMap = {}, e.call = function(t, n) {
        for (var i = [], s = 2, o = arguments.length; o > s; s++) i.push(arguments[s]);
        e.use(t, function(e) {
            for (var t = n.split("."), r = 0, s = t.length; s > r; r++) e = e[t[r]];
            e && e.apply(this, i);
        });
    }, e._setContext = function(e) {
        "object" == typeof e && r(e, function(e, t) {
    ...
    n.each = function(e, t, n) {
        ...
        if ("function" == typeof t) for (s = 0; o > s && (i = e[s], r = t.call(n || e, s, i), 
        r !== !1); s++) ;
        return e;
    };
    var r = function(e, t) {
    ...
    n.extend = function() {
        for (var e = arguments[0], t = 1, n = arguments.length; n > t; t++) r(e, arguments[t]);
        return e;
...
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module("base/class", function(e, t) {
...
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module("conf/const", function(e, t) {
    ...
    window._bd_share_main.F._setMod("api"), window._bd_share_main.F._fileMap({
        ...
        "/css/share_style0_16.css?v=89a7173d.css": [ "share_style0_16.css" ],
        "/css/share_style0_32.css?v=9ebeb48a.css": [ "share_style0_32.css" ],
        "/css/share_style2.css?v=d9f6b4a7.css": [ "share_style2.css" ],
        "/css/share_style4.css?v=784a8fcf.css": [ "share_style4.css" ],
        "/css/slide_share.css?v=0c86db4f.css": [ "slide_share.css" ],
        "/css/share_popup.css?v=041dd590.css": [ "share_popup.css" ],
        "/css/like.css?v=d52a0ea5.css": [ "like.css" ],
        "/css/imgshare.css?v=c0974f99.css": [ "imgshare.css" ],
        "/css/select_share.css?v=5cb5a2e0.css": [ "select_share.css" ],
        "/css/weixin_popup.css?v=1a56666e.css": [ "weixin_popup.css" ]
    }), window._bd_share_main.F._loadScriptTimeout = 15e3, window._bd_share_main.F._useConfig = !0, 
    window._bd_share_main.F._firstScreenCSS = "", window._bd_share_main.F._firstScreenJS = "";
    ...
    _bd_share_main.init = function(e) {
        if (e = e || window._bd_share_config || {
            ...
            var t = i(e);
            t.like && r([ "share/like_api", "view/like_view" ], t.like), t.share && r([ "share/share_api", "view/share_view" ], t.share), 
            t.slide && r([ "share/slide_api", "view/slide_view" ], t.slide), t.selectShare && r([ "share/select_api", "view/select_view" ], t.selectShare), 
            t.image && r([ "share/image_api", "view/image_view" ], t.image);
        }
    }, window._bd_share_main._LogPoolV2 = [], window._bd_share_main.n1 = new Date().getTime(), 
    t.domready(function() {
    ...
    var n = function() {
        ...
        for (var n = e.length, r = "", i = 1; t >= i; i++) {
    ...
    var n = e("component/comm_tools"), r = e("conf/const").URLS, i = function() {
        ...
        var n = r.jumpUrl;
        "mshare" == e.__cmd ? n = r.mshareUrl : "mail" == e.__cmd && (n = r.emailUrl);
        var i = n + "?" + f(t);
        window.open(i);
    }, a = function(e) {
        if (e) {
