!function(t) {
    ...
    function s(t, e, i) {
        ...
        "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = r(t), 
        this.options = n({}, this.options), "function" == typeof e ? i = e : n(this.options, e), 
        i && this.on("always", i), this.getImages(), h && (this.jqDeferred = new h.Deferred());
        var o = this;
        setTimeout(function() {
            o.check();
        });
    ...
    var h = t.jQuery, c = t.console, p = void 0 !== c, d = Object.prototype.toString;
    s.prototype = new e(), s.prototype.options = {}, s.prototype.getImages = function() {
        ...
        function t(t, o) {
            return e.options.debug && p && c.log("confirm", t, o), e.progress(t), i++, i === n && e.complete(), 
            !0;
        }
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var x = e(n.height);
                return x !== !1 && (o.height = x + (L ? 0 : g + w)), o.innerWidth = o.width - (y + E), 
                o.innerHeight = o.height - (g + w), o.outerWidth = o.width + v, o.outerHeight = o.height + b, 
                o;
            }
        }
        function a(t, e) {
        ...
        return function() {
            if (h) {
                ...
                t.style.borderWidth = "1px 2px 3px 4px", t.style[h] = "border-box";
    ...
    function o(t, o, r) {
        ...
        a.prototype._transitionTo = function(t, e) {
            ...
            a = c.isOriginLeft ? a : -a, u = c.isOriginTop ? u : -u, h.transform = m(a, u), 
            this.transition({
                to: h,
                onTransitionEnd: {
    ...
    function s(i, s, p, l, f, m) {
        ...
        return y.namespace = "outlayer", y.Item = m, y.defaults = {
            ...
            n.prototype.constructor = n, n.defaults = e({}, y.defaults), e(n.defaults, i), n.prototype.settings = {}, 
            n.namespace = t, n.data = y.data, n.Item = function() {
    ...
    var a = t.document, u = t.console, h = t.jQuery, c = function() {}, p = Object.prototype.toString, d = "object" == typeof HTMLElement ? function(t) {
    ...
    i.notify = function(t, r) {
        e(n, t), a && (n.style[a] = "none"), n.style.display = "block", n.style.opacity = "1", 
    ...
    n.events = function() {
        !function() {
            var t = document.querySelector("#layout-complete-demo .masonry"), e = new Masonry(t, {
                columnWidth: 60
            });
            ...
            var t = document.querySelector("#remove-complete-demo .masonry"), e = new Masonry(t, {
                columnWidth: 60
            });
    ...
    e.faq = function() {
        !function() {
            var t = document.querySelector("#animate-item-size .masonry"), e = new Masonry(t, {
                columnWidth: 60
            });
            eventie.bind(t, "click", function(t) {
                var i = t.target;
    ...
    function i(t) {
        ...
        return o.className = "example-title", o.textContent = t.title, i.appendChild(n), 
        i.appendChild(o), e.appendChild(i), e;
    }
    var n, o, r, s = t.MD;
    s.index = function() {
        !function() {
    ...
    i.methods = function() {
        !function() {
            var t = document.querySelector("#appended-demo"), i = t.querySelector(".masonry"), n = t.querySelector("button"), o = new Masonry(i, {
                columnWidth: 60
            });
            ...
            var t = document.querySelector("#destroy-demo"), e = t.querySelector(".masonry"), i = t.querySelector("button"), n = new Masonry(e, {
                columnWidth: 60
            }), o = !0;
            ...
            var t = document.querySelector("#layout-demo .masonry"), e = new Masonry(t, {
                columnWidth: 60
            });
            eventie.bind(t, "click", function(t) {
                classie.has(t.target, "item") && (classie.toggle(t.target, "gigante"), e.layout());
            ...
            var t = document.querySelector("#prepended-demo"), i = t.querySelector(".masonry"), n = t.querySelector("button"), o = new Masonry(i, {
                columnWidth: 60
            });
            eventie.bind(n, "click", function() {
                for (var t = [], n = document.createDocumentFragment(), r = 0; 3 > r; r++) {
            ...
            var t = document.querySelector("#remove-demo .masonry"), e = new Masonry(t, {
                columnWidth: 60
            });
            eventie.bind(t, "click", function(t) {
