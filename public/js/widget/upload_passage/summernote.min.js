/**
 * Created by redrock on 2015/4/15.
 */
!function(a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function(b) {
        ...
        var b = function(b) {
            ...
            var e;
            return e = c.is(".note-editor, .note-air-editor") ? c : a("#note-editor-" + g.last(c.attr("id").split("-"))), 
            d(e);
        }, l = function(a) {
            ...
            } else Y(a.node) ? (d = a.node.childNodes[a.offset - 1], e = E(d)) : (d = a.node, 
            e = c ? 0 : a.offset - 1);
            return {
                node: d,
                offset: e
            ...
            var c = a.node.childNodes[a.offset], d = Q(a.node.cloneNode(!1), a.node);
            ...
            var c, d, e = b ? o : w, f = J(a.node, e), h = g.last(f) || a.node;
            ...
            var c = ja(b);
            return a.style.cssText && (c.style.cssText = a.style.cssText), R(c, g.from(a.childNodes)), 
            Q(c, a), la(a), c;
        }, oa = l("TEXTAREA"), pa = function(b, c) {
        ...
        var b = function(a, b) {
            ...
            if (0 !== c && j.isText(h[c - 1])) {
                ...
                k = k.nextSibling;
                k.nodeValue, b && k.nextSibling && j.isText(k.nextSibling) && m === k.nodeValue.length && (m -= k.nodeValue.length, 
                k = k.nextSibling), e = k, c = m;
            }
            return {
                cont: e,
                offset: c
            ...
            this.getPoints = function() {
                ...
                var a = function(a) {
                    return j.isVisiblePoint(a) || (a = j.isLeftEdgePoint(a) ? j.nextPointUntil(a, j.isVisiblePoint) : j.prevPointUntil(a, j.isVisiblePoint)), 
                    a;
                ...
                return j.isText(i) && !j.isEdgePoint(this.getEndPoint()) && i.splitText(k), j.isText(b) && !j.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(h), 
                c.so = 0, a && (c.ec = c.sc, c.eo = k - h)), new d(c.sc, c.so, c.ec, c.eo);
            ...
            this.isOnEditable = m(j.isEditable), this.isOnList = m(j.isList), this.isOnAnchor = m(j.isAnchor), 
            this.isOnCell = m(j.isCell), this.isLeftEdgeOf = function(a) {
        ...
        return {
            create: function(a, c, f, g) {
                if (arguments.length) 2 === arguments.length && (f = a, g = c); else if (e.isW3CRangeSupport) {
                    ...
                    a = n.cont, c = n.offset, f = o.cont, g = o.offset;
                }
                return new d(a, c, f, g);
            },
            createFromNode: function(a) {
                var b = a, c = 0, d = a, e = j.nodeLength(d);
                return j.isVoid(b) && (c = j.listPrev(b).length - 1, b = b.parentNode), j.isBR(d) ? (e = j.listPrev(d).length - 1, 
                d = d.parentNode) : j.isVoid(d) && (e = j.listPrev(d).length, d = d.parentNode), 
                this.create(b, c, d, e);
            },
        ...
        this.stylePara = function(b, c) {
            ...
            var i = j.makePredByNodeName(d), k = a.map(b.nodes(j.isText, {
                fullyContains: !0
            }), function(a) {
            ...
            if (g["font-size"] = parseInt(g["font-size"], 10), g["font-bold"] = document.queryCommandState("bold") ? "bold" : "normal", 
            g["font-italic"] = document.queryCommandState("italic") ? "italic" : "normal", g["font-underline"] = document.queryCommandState("underline") ? "underline" : "normal", 
            g["font-strikethrough"] = document.queryCommandState("strikeThrough") ? "strikethrough" : "normal", 
            g["font-superscript"] = document.queryCommandState("superscript") ? "superscript" : "normal", 
            g["font-subscript"] = document.queryCommandState("subscript") ? "subscript" : "normal", 
            c.isOnList()) {
            ...
            return g.image = j.isImg(d) && d, g.anchor = c.isOnAnchor() && j.ancestor(c.sc, j.isAnchor), 
            g.ancestors = j.listAncestor(c.sc, j.isEditable), g.range = c, g;
        };
    }, q = function() {
        ...
        this.insertOrderedList = function() {
            ...
            var b = this, c = k.create().wrapBodyInlineWithPara(), d = c.nodes(j.isPara, {
                includeAncestor: !0
            ...
            var c = this, d = k.create().wrapBodyInlineWithPara(), e = d.nodes(j.isPara, {
                includeAncestor: !0
            ...
            }), j.appendChildNodes(i, b), h && (j.appendChildNodes(i, g.from(h.childNodes)), 
            j.remove(h)), b;
        ...
        var b = new p(), c = new r(), d = new q(), f = new s();
        ...
        this.tab = function(a, b) {
            var e = k.create();
            e.isCollapsed() && e.isOnCell() ? c.tab(e) : (l(a), d.insertTab(a, e, b.tabsize), 
            n(a));
        }, this.untab = function() {
            var a = k.create();
            ...
            l(a), b = e.isMSIE ? "<" + b + ">" : b, document.execCommand("FormatBlock", !1, b), 
            n(a);
        ...
        this.fontSize = function(c, d) {
            l(c);
            var e = this.createRange(c), f = b.styleNodes(e);
            ...
            l(a), d && document.execCommand("foreColor", !1, d), e && document.execCommand("backColor", !1, e), 
            n(a);
            ...
            l(a), c.removeClass("img-rounded img-circle img-thumbnail"), b && c.addClass(b), 
            n(a);
        ...
        this.update = function(b, c) {
            ...
            if (j.length) {
                var k = c["font-family"];
                if (k) {
                    for (var l = k.split(","), m = 0, n = l.length; n > m && (k = l[m].replace(/[\'\"]/g, "").replace(/\s+$/, "").replace(/^\s+/, ""), 
                    !e.isFontInstalled(k)); m++) ;
        ...
        var c = function(a) {
            ...
            var c = j.makeLayoutInfo(a.target).editable(), d = c.offset().top - b.scrollTop(), e = j.makeLayoutInfo(a.currentTarget || a.target), f = e.editor().data("options");
            b.on("mousemove", function(a) {
                var b = a.clientY - (d + w);
                b = f.minHeight > 0 ? Math.max(b, f.minHeight) : b, b = f.maxHeight > 0 ? Math.min(b, f.maxHeight) : b, 
                c.height(b);
        ...
        this.update = function(h, i, j) {
            ...
            if (i.anchor) {
                ...
                l.attr("href", m).html(m), n ? l.attr("target", "_blank") : l.removeAttr("target"), 
                d(k, c(i.anchor, j));
            } else k.hide();
        ...
        var c = a(document), d = function(d) {
            if (j.isControlSizing(d.target)) {
                ...
                var e = j.makeLayoutInfo(d.target), f = e.handle(), g = e.popover(), h = e.editable(), i = e.editor(), k = f.find(".note-control-selection").data("target"), l = a(k), m = l.offset(), n = c.scrollTop(), o = i.data("options").airMode;
    ...
    var B = function(a) {
        this.sync = function(b) {
            ...
            var d = c.editor(), f = c.toolbar(), g = c.editable(), h = c.codable(), i = c.popover(), k = c.handle(), l = d.data("options");
            if (h.val(j.html(g, l.prettifyHtml)), h.height(g.height()), a.invoke("toolbar.updateCodeview", f, !0), 
            a.invoke("popover.hide", i), a.invoke("handle.hide", k), d.addClass("codeview"), 
            h.focus(), e.hasCodeMirror) {
            ...
            var c = b.editor(), d = b.toolbar(), f = b.editable(), g = b.codable(), h = c.data("options");
            if (e.hasCodeMirror) {
                var i = g.data("cmEditor");
                g.val(i.getValue()), i.toTextArea();
            }
            f.html(j.value(g, h.prettifyHtml) || j.emptyPara), f.height(h.height ? g.height() : "auto"), 
            c.removeClass("codeview"), f.focus(), a.invoke("toolbar.updateCodeview", d, !1);
        };
    }, C = function(b) {
        var c = a(document);
        this.attach = function(a, b) {
            ...
            c.on("dragenter", function(a) {
                ...
                c || f.length || !j || (g.addClass("dragover"), h.width(g.width()), h.height(g.height()), 
                i.text(e.langInfo.image.dragImageHere)), f = f.add(a.target);
                ...
                c.preventDefault();
                var d = c.originalEvent.dataTransfer, e = d.getData("text/html"), f = d.getData("text/plain"), g = j.makeLayoutInfo(c.currentTarget || c.target);
        ...
        var c = function(c) {
            var d = c.originalEvent.clipboardData, e = j.makeLayoutInfo(c.currentTarget || c.target), f = e.editable();
            if (!d || !d.items || !d.items.length) {
                var h = f.data("callbacks");
                if (!h.onImageUpload) return;
                return b.invoke("editor.saveNode", f), b.invoke("editor.saveRange", f), f.html(""), 
                void setTimeout(function() {
                    ...
                    if (c.length && -1 !== c[0].src.indexOf("data:")) {
                        ...
                        j.name = "clipboard.png", b.invoke("editor.restoreNode", f), b.invoke("editor.restoreRange", f), 
                        b.insertImages(e, [ j ]), b.invoke("editor.afterCommand", f);
                    } else {
                        var k = f.html();
            ...
            var i = g.head(d.items), k = "file" === i.kind && -1 !== i.type.indexOf("image/");
        ...
        this.showLinkDialog = function(b, d, e) {
            return a.Deferred(function(a) {
                var b = d.find(".note-link-dialog"), f = b.find(".note-link-text"), g = b.find(".note-link-url"), h = b.find(".note-link-btn"), i = b.find("input[type=checkbox]");
                b.one("shown.bs.modal", function() {
                    ...
                    }).val(e.url).trigger("focus").trigger("select"), i.prop("checked", e.newWindow), 
        ...
        this.show = function(a) {
            ...
            return a.Deferred(function(a) {
                var b = d.find(".note-image-dialog"), e = d.find(".note-image-input"), f = d.find(".note-image-url"), g = d.find(".note-image-btn");
                b.one("shown.bs.modal", function() {
                    e.replaceWith(e.clone().on("change", function() {
                        ...
                        var b;
                        b = "paste" === a.type ? a.originalEvent.clipboardData.getData("text") : f.val(), 
                        c(g, b);
                    }).val("").trigger("focus");
                }).one("hidden.bs.modal", function() {
        ...
        this.invoke = function() {
            var a = g.head(g.from(arguments)), b = g.tail(g.from(arguments)), c = a.split("."), d = c.length > 1, e = d && g.head(c), f = d ? g.last(c) : g.head(c), h = this.getModule(e), i = h[f];
            return i && i.apply(h, b);
        }, this.getModule = function(a) {
            return this.modules[a] || this.modules.editor;
        }, this.insertImages = function(c, d) {
            var e = c.editor(), f = c.editable(), g = c.holder(), h = f.data("callbacks"), i = e.data("options");
            h.onImageUpload ? (h.onImageUpload(d, b.editor, f), q(g, "image.upload")([ d ])) : a.each(d, function(a, c) {
                var d = c.name;
                i.maximumImageFileSize && i.maximumImageFileSize < c.size ? h.onImageUploadError ? (h.onImageUploadError(i.langInfo.image.maximumFileSizeError), 
                q(g, "image.upload.error")(i.langInfo.image.maximumFileSizeError)) : alert(i.langInfo.image.maximumFileSizeError) : m.readFileAsDataURL(c).then(function(a) {
        ...
        var c = {
            ...
            setTimeout(function() {
                var c = j.makeLayoutInfo(a.currentTarget || a.target), d = b.editor.currentStyle(a.target);
                if (d) {
            ...
            if (e.length) {
                var h, i = e.attr("data-event"), k = e.attr("data-value"), l = e.attr("data-hide"), m = j.makeLayoutInfo(d.target);
                if (-1 !== a.inArray(i, [ "resize", "floatMe", "removeMedia", "imageShape" ])) {
                    var n = m.handle().find(".note-control-selection");
                    h = a(n.data("target"));
                }
                if (l && e.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[i])) a.summernote.pluginEvents[i](d, b.editor, m, k); else if (b.editor[i]) {
                    var o = m.editable();
                    o.focus(), b.editor[i](o, k, h), d.preventDefault();
                } else c[i] && (c[i].call(this, m), d.preventDefault());
                if (-1 !== a.inArray(i, [ "backColor", "foreColor" ])) {
                    var p = m.editor().data("options", p), q = p.airMode ? b.popover : b.toolbar;
        ...
        this.bindKeyMap = function(d, e) {
            ...
            g.on("keydown", function(h) {
                ...
                j && i.push(j);
                var k = e[i.join("+")];
                if (k) if (a.summernote.pluginEvents[k]) {
                    var l = a.summernote.pluginEvents[k];
                    a.isFunction(l) && l(h, b.editor, d);
                } else b.editor[k] ? (b.editor[k](g, f.data("options")), h.preventDefault()) : c[k] && (c[k].call(this, d), 
                h.preventDefault()); else n.isEdit(h.keyCode) && b.editor.afterCommand(g);
            });
        }, this.attach = function(a, c) {
            c.shortcuts && this.bindKeyMap(a, c.keyMap[e.isMac ? "mac" : "pc"]), a.editable().on("mousedown", d), 
            a.editable().on("keyup mouseup", f), a.editable().on("scroll", h), b.clipboard.attach(a, c), 
            b.handle.attach(a, c), a.popover().on("click", k), a.popover().on("mousedown", i), 
            b.dragAndDrop.attach(a, c), c.airMode || (a.toolbar().on("click", k), a.toolbar().on("mousedown", i), 
            b.statusbar.attach(a, c));
            var l = c.airMode ? a.popover() : a.toolbar(), m = l.find(".note-dimension-picker-mousecatcher");
            m.css({
            ...
            }), c.onfocus && a.editable().focus(c.onfocus), c.onblur && a.editable().blur(c.onblur), 
            c.onkeyup && a.editable().keyup(c.onkeyup), c.onkeydown && a.editable().keydown(c.onkeydown), 
            c.onpaste && a.editable().on("paste", c.onpaste), c.onToolbarClick && a.toolbar().click(c.onToolbarClick), 
            c.onChange) {
                var r = function() {
            ...
            var d = b.holder(), f = b.editable();
            if (f.on("mousedown", q(d, "mousedown")), f.on("keyup mouseup", q(d, "update")), 
            f.on("scroll", q(d, "scroll")), f.keypress(function(a) {
                a.keyCode === n.ENTER && q(d, "enter").call(this, a);
            }), f.focus(q(d, "focus")), f.blur(q(d, "blur")), f.keyup(q(d, "keyup")), f.keydown(q(d, "keydown")), 
            f.on("paste", q(d, "paste")), c.airMode || (b.toolbar().click(q(d, "toolbar.click")), 
            b.popover().click(q(d, "popover.click"))), e.isMSIE) {
            ...
            a.holder().off(), a.editable().off(), a.popover().off(), a.handle().off(), a.dialog().off(), 
        ...
        var b = function(a, b) {
            ...
            fontname: function(a, c) {
                var d = [], f = c.fontNames.reduce(function(a, b) {
                    return e.isFontInstalled(b) || -1 !== c.fontNamesIgnoreCheck.indexOf(b) ? (d.push(b), 
                    a + '<li><a data-event="fontName" href="#" data-value="' + b + '" style="font-family:\'' + b + '\'"><i class="' + c.iconPrefix + 'check"></i> ' + b + "</a></li>") : a;
                }, ""), g = e.isFontInstalled(c.defaultFontName), h = g ? c.defaultFontName : d[0], i = '<span class="note-current-fontname">' + h + "</span>";
                return b(i, {
                    title: a.font.name,
            ...
            help: function(a, b) {
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.4</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
        ...
        this.createLayoutByAirMode = function(b, c) {
            ...
            l.addClass("note-air-layout"), l.attr("id", "note-popover-" + h), l.appendTo(j), 
            x(l, g), y(l, c);
            var m = a(k());
            ...
            return b.length ? (b.data("holder", a), j.buildLayoutInfo(b)) : void 0;
        }, this.removeLayout = function(a, b, c) {
            c.airMode ? (a.removeClass("note-air-editor note-editable").removeAttr("id contentEditable"), 
            b.popover().remove(), b.handle().remove(), b.dialog().remove()) : (a.html(b.editable().html()), 
            b.editor().remove(), a.show());
    ...
    a.extend(a.summernote, {
        ...
        summernote: function() {
            var b = a.type(g.head(arguments)), c = "string" === b, d = "object" === b, e = d ? g.head(arguments) : {};
            e = a.extend({}, a.summernote.options, e), e.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote.lang[e.lang]), 
            ...
            if (f.length) {
                ...
                if (c) {
                    var i = g.head(g.from(arguments)), j = g.tail(g.from(arguments)), k = [ i, h.editable() ].concat(j);
        ...
        code: function(b) {
            if (void 0 === b) {
                var c = this.first();
                if (!c.length) return;
                var d = J.layoutInfoFromHolder(c), e = d && d.editable();
                if (e && e.length) {
            ...
            return this.each(function(c, d) {
                var e = J.layoutInfoFromHolder(a(d)), f = e && e.editable();
                f && f.html(b);
            }), this;
        },
        destroy: function() {
            return this.each(function(b, c) {
                var d = a(c);
                if (J.hasNoteEditor(d)) {
                    var e = J.layoutInfoFromHolder(d), f = e.editor().data("options");
