...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="{{URL::asset('public/admin/dist/css/timeline.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{URL::asset('public/admin/dist/css/sb-admin-2.css')}}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{URL::asset('public/admin/bower_components/morrisjs/morris.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{URL::asset('public/admin/bower_components/flot/excanvas.min.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/flot/jquery.flot.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/flot/jquery.flot.time.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{URL::asset('public/admin/js/flot-data.js')}}"></script>
