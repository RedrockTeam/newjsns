...
<body>
    ...
    <!-- /#wrapper -->
{{URL::asset('public/admin/dist/js/sb-admin-2.js')}}
    <!-- jQuery -->
    ...
    <script src="{{URL::asset('public/admin/bower_components/raphael/raphael-min.js')}}"></script>
    <script src="{{URL::asset('public/admin/bower_components/morrisjs/morris.min.js')}}"></script>
    <script src="{{URL::asset('public/admin/js/morris-data.js')}}"></script>
