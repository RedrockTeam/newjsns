...
@section("css")
    ...
    {{HTML::style("css/template/login-register/login-register.css", [], true)}}
@stop
...
@stop
@section("script")
    {{HTML::script("js/lib/require.js", ["data-main" => url("js/template/login-register/login-register.js", [], true)], true)}}
@stop
