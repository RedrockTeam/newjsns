<div class="m-login-register-case">
    ...
    {{--登陆 默认关闭--}}
    <form action="https://redrock.cqupt.edu.cn/jsns/home/login" novalidate method="POST"  class="u-login s-form f-cb js-login-form">
...
@section("css")
    @parent
    {{HTML::style("css/widget/login-register-case/login-register-case.css", [], true)}}
@stop