...
<script type="text/template" id="js-photo_temp">
     <div class="wf_item_inner">
        ...
        <%}%>
        <div class="u-action"><div class="u-show_love js-praise" data-type_id="<%= data.type_id%>" data-passage_id="<%= data.passage_id%>"><i class="fa fa-heart js-show_love"></i><span class="js-num">(<%= data.love_count%>)</span></div></div>
     </div>
</script>
@section("css")
    @parent
