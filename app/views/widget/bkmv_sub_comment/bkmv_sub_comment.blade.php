<div class="m-bkmv_comments js-passage_info js-comment_father" data-type_id="{{Input::get('type_id')}}" data-passage_id="{{Input::get('passage_id')}}">
...
@section("css")
    @parent
    {{HTML::style("css/widget/bkmv_sub_comment/bkmv_sub_comment.css", [], true)}}
@stop