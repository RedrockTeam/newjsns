 ...
 * Generated for Laravel 4.2.17 on 2015-02-20.
 *
...
namespace {
    ...
    class JitImage extends \Thapp\JitImage\Facades\JitImage{
        ...
        public static function source($source){
            return \Thapp\JitImage\JitImage::source($source);
        }
        ...
        public static function toJpeg(){
            return \Thapp\JitImage\JitImage::toJpeg();
        }
        ...
        public static function toPng(){
            return \Thapp\JitImage\JitImage::toPng();
        }
         ...
         * @static 
         */
        public static function toGif(){
            return \Thapp\JitImage\JitImage::toGif();
        }
        ...
        public static function resize($width, $height){
            \Thapp\JitImage\JitImage::resize($width, $height);
        }
         ...
         * @static 
         */
        public static function crop($width, $height, $gravity, $background = null){
            \Thapp\JitImage\JitImage::crop($width, $height, $gravity, $background);
        }
         ...
         * @static 
         */
        public static function cropAndResize($width, $height, $gravity){
            \Thapp\JitImage\JitImage::cropAndResize($width, $height, $gravity);
        }
        ...
        public static function fit($width, $height){
            \Thapp\JitImage\JitImage::fit($width, $height);
        }
         ...
         * @static 
         */
        public static function scale($percent){
            \Thapp\JitImage\JitImage::scale($percent);
        }
         ...
         * @static 
         */
        public static function pixel($pixel){
            \Thapp\JitImage\JitImage::pixel($pixel);
        }
         ...
         * @static 
         */
        public static function filter($name, $options = null){
            return \Thapp\JitImage\JitImage::filter($name, $options);
        }
        ...
        public static function filters($filters){
            return \Thapp\JitImage\JitImage::filters($filters);
        }
